  ...
  return (
    ...
    >
      <div style={{
        ...
        {/* Android Phone Body — white, slightly flatter corners than iPhone */}
        <div style={{
          width: "240px",
          borderRadius: "36px",
          ...
          {/* Screen — Android style corners (less rounded than iPhone) */}
          <div style={{
            borderRadius: "26px",
            overflow: "hidden",
            background: "#000",
  ...
  return (
    <>
      <style>{`
        ...
        .cp-eyebrow::before { content: ''; width: 32px; height: 1px; background: #0A84FF; }
        ...
        .cp-meta { display: flex; gap: 56px; flex-wrap: wrap; margin-bottom: 44px; align-items: flex-start; }
        .cp-desc { max-width: 500px; font-size: 15px; line-height: 1.9; color: #5d7287; font-weight: 300; }
        .cp-info { display: flex; flex-direction: column; gap: 18px; }
        .cp-info-item label { display: block; font-size: 9px; letter-spacing: 0.25em; text-transform: uppercase; color: #2e4055; margin-bottom: 4px; }
        .cp-info-item span { font-size: 13px; color: #7a95aa; }

        .cp-tags { display: flex; gap: 10px; flex-wrap: wrap; }
        .cp-tag {
        ...
        .cp-gallery-label {
          ...
          color: #2e4055; margin-bottom: 64px;
        }
        .cp-gallery-label::before { content: ''; width: 20px; height: 1px; background: rgba(10,132,255,0.3); }
        .cp-gallery-label::after { content: ''; flex: 1; height: 1px; background: linear-gradient(90deg, rgba(10,132,255,0.15), transparent); }
        ...
        @media (max-width: 960px) {
          .cp-grid { grid-template-columns: repeat(2, 1fr); gap: 48px 24px; }
          .cp-hero { padding: 80px 6% 60px; }
        }
        @media (max-width: 560px) {
          .cp-grid { grid-template-columns: repeat(2, 1fr); gap: 32px 16px; }
          .cp-hero { padding: 72px 5% 48px; }
          .cp-gallery-wrap { padding: 60px 5% 80px; }
          .cp-meta { flex-direction: column; gap: 28px; }
        }
      `}</style>
        ...
        <div className="cp-hero">
          ...
          <div className="cp-meta">
            ...
            <div className="cp-info">
              <div className="cp-info-item"><label>Category</label><span>E-Commerce</span></div>
              <div className="cp-info-item"><label>Year</label><span>2024</span></div>
              <div className="cp-info-item"><label>Role</label><span>Full Stack Dev</span></div>
              <div className="cp-info-item"><label>Platform</label><span>Android & Web</span></div>
            </div>
          </div>
          <div className="cp-tags">
            {tech.map(t => <span key={t} className="cp-tag">{t}</span>)}
          </div>
        </div>
