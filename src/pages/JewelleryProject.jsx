    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span style={{ fontSize: "10px", color: "#28c840", opacity: 0.8 }}>
              🔒
            </span>
            <span
              style={{
    ...
    <>
      <style>{`
        ...
        .jp-meta {
          ...
          gap: 20px;
          flex-wrap: wrap;
          margin-bottom: 14px;   /* 👈 desc கீழ gap kammi */
        ...
        /* GALLERY */
        .jp-gallery-wrap {
          padding: 28px 6% 80px;   /* 👈 project screens section mela gap kammi */
        ...
        .jp-gallery-label {
          ...
          text-transform: uppercase;
          color: #2e4055;
          margin-bottom: 24px;   /* 👈 label கீழ gap kammi */
          flex-wrap: wrap;
        }

        .jp-gallery-label::before {
          content: '';
          width: 20px;
          height: 1px;
        ...
        @media (max-width: 400px) {
          .jp-hero {
            padding: 12px 4.5% 10px;
          }

          .jp-gallery-wrap {
            padding: 18px 4.5% 48px;
          }
